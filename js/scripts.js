$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> This functionality is not available yet. '));
    });
...
// Google map
function initMap() {
    var location = {lat: 54.635769785045426, lng: -5.719133098023509};
